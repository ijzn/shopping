            ...
            <div class="container">
                <div class="checkout-addr">
                    ...
                    <div class="addr-list-wrap">
                        <div class="addr-list">
                            <ul>
                                <li v-for="(item,index) in addressList" :key="index" :class="{'check':checkIndex==index}" @click="checkIndex=index;selectedAddrId=item.addressId">
                                    ...
                                    <div class="addr-opration addr-set-default" v-if="!item.isDefault" @click="stDefault(item.addressId)">
                        ...
                        <div class="shipping-addr-more" @click="expand">
                    ...
                    <div class="next-btn-wrap">
                        <router-link class="btn btn--m btn--red" :to="{path:'/order',query:{addrId:selectedAddrId}}">结账</router-link>
                    </div>
                </div>
            </div>
        </div>
            ...
            init(){
                ...
                .then((response)=>{
                    ...
                    this.address.forEach((el)=>{
                        if (el.isDefault) {
                           this.selectedAddrId = el.addressId; 
                        }
                    })
                })
            },
