<template>
    <div>
        ...
        <div class="container">
            <div class="cart">
                    ...
                    <li v-for="(item,index) in cartList" :key="index">
                        ...
                        <div class="item-quantity">
                            ...
                            <div class="select-self-area">
                                <a class="input-sub" @click="editCart('add',item)">+</a>
                                <span class="select-ipt">{{item.productNum}}</span>
                                <a class="input-add" @click="editCart('sub',item)">-</a>
                            </div>
                            </div>
                        </div>
                        </div>
                ...
                <div class="cart-foot-inner">
                    ...
                    <div class="btn-wrap">
                        <a class="btn btn--red" :class="{'btn--dis': checkedCount==0}" @click="checkOut">提交订单</a>
                    </div>
                    </div>
                </div>
                </div>
        ...
        <Modal :mdShow="mdConfirm" @close="closeMd">
            <p slot="message">你确定删除数据么？数据删除后无法恢复。</p>
            <div slot="btnGroup" >
...
export default {
    ...
    methods: {
        ...
        delCart(){
            this.$axios.post('/users/cart/del',{
