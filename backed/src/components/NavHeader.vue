<template>
    <header class="header">
        ...
        <div class="navbar">
            ...
            <div class="navbar-right-container" style="display: flex;">
                <div class="navbar-menu-container">
                    ...
                    <a href="javascript:void(0)" class="navbar-link" v-if="!nickName" @click="loginModalFlag=true;errTip=false">Login</a>
        ...
        <div class="md-overlay" :class="{'md-show':loginModalFlag}" v-if="loginModalFlag" @click="loginModalFlag=false"></div>
    </header>
</template>
